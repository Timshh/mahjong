...
class AssetManager {
 ...
 private:
  ...
  sf::Texture Outline, Shadow, ShadowOutline, Back, Selected, Button, ButtonSelected,
      Word1,
  ...
  const sf::Vector2i CardSize = sf::Vector2i(90, 120),
                     OutlineSize = sf::Vector2i(94, 124),
                     ShadowSize = sf::Vector2i(90, 120),
                     ShadowOutlineSize = sf::Vector2i(95, 125),
